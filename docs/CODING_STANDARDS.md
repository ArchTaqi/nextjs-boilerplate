...
Specific guidelines the following coding standards are also heavily inspired by the [Angular Material Coding Standards](https://github.com/angular/components/blob/master/CODING_STANDARDS.md) and the [Google JavaScript Style Guide](https://google.github.io/styleguide/jsguide.html)
